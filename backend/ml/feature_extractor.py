...
class FeatureExtractor:
    # Extracts geometric AU-proxy features from 468 MediaPipe landmarks.
    # Based on NFCS/NIPS pain coding: AU4, AU6+7, AU9+10, AU43, AU27.
    ...
    def extract(self, landmarks: np.ndarray) -> dict:
        ...
        # AU6+7, AU43 eye squeeze / closure (EAR)
        ...
        # eye asymmetry — pain is often asymmetric
